...
if(!abonerol) return message.channel.send(`Abone rolü ayarlanmamış!`)
  ...
  if(!message.mentions.users.first()) return message.channel.send(` <a:792704133903810560:806932613322768404> **Bir Üye Etiketle!**`)
  
  await(abonekisi.roles.add(abonerol))
  
  const embed = new Discord.MessageEmbed()
  .setTitle(`Abone Rolü Verildi! <a:yes:802629858365669437>  `)
