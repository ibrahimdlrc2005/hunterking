...
if(!args[0]) return message.channel.send(new Discord.MessageEmbed().setTitle('**Silinecek miktar giriniz.** <a:emoji_16:768686831063531530>'));
...
.setTitle('Tamamdır Patron! '+`${args[0]}`+' adet mesaj silindi. <a:yes:802629858365669437> ')).then(m => m.delete({timeout: 3900}));
};
exports.conf = {
  enabled: true,
  guildOnly: true,
