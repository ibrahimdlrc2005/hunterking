...
exports.run = async (bot, message, args) => {
 if (!message.guild) {
  ...
  if (args[0] === 'aç') {
    ...
    message.channel.send(`Artık bot Sa diyince As diyecek. <a:yes:802629858365669437>  Kapatmak için "\`.sa-as kapat\`" yazmalısın.`)
  ...
  if (args[0] === 'kapat') {
    ...
    message.channel.send(`Artık biri sa diyince cevap vermeyecek. <a:792704133903810560:806932613322768404>`)
